...
function init() {
    ...
    window.p2pMediaEngine = engine = new BeekeeprUniversalEngine.Engine();
    ...
    BeekeeprMonitoring.BKProxyBaseMonitor.renderDOM("proxy-monitor-react-root", engine.getProxy())
