...
// FIXME: adapt things here or there to not make this necessary anymore
window.p2pml = {
...
var DemoApp = (function () {
    ...
    function DemoApp() {
        ...
        // FIXME: build demo with webpack and import deps at compile time
        if (!P2PGraph) {
            throw new Error('Need global P2PGraph install')
        }
    ...
    DemoApp.prototype.initJwPlayer = function () {
        ...
        // FIXME: build demo with webpack and import deps at compile time
        if (!jwplayer_hls_provider) {
            throw new Error('Need global JWPlayer HLS provider install');
        }
